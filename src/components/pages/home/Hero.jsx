    ...
    () => {
      const ctx = gsap.context(() => {
        ...
        gsap
          ...
          .fromTo(
            ".text1",
            { opacity: 0, scale: 0.8, y: device === "mobile" ? "25vh" : "" },
          ...
          .fromTo(
            ...
            { scale: 0.8, y: "20vh" },
            { opacity: 1, scale: 1, y: 0, duration: 0.8, ease: "power1.out" }
          )
      ...
      <div className="section h-[calc(100vh-60px)] w-full flex flex-col sm:flex-row items-center justify-between heroSec1">
        ...
        <div className="flex-1 md:block hidden">
          <div className="flex justify-end">
            <div className="w-3/6 text-end fadeOut">
              <h5>
