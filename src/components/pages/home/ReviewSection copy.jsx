...
const ReviewSection = () => {
  ...
  return (
    <div ref={containerRef} className='container'>
      ...
      <div className='h-[calc(100vh-60px)] flex items-center justify-center first-content relative'>
      ...
      {/* <div className='min-h-[calc(100vh-60px)] flex items-center justify-center third-content opacity-0'>
